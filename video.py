...
#Include YOLOv5
modelY = torch.hub.load('ultralytics/yolov5', 'yolov5s')
...
cap = cv2.VideoCapture('/home/erich/Documents/trt_pose/tasks/human_pose/example.mp4')
#cap.set(cv2.CAP_PROP_FRAME_WIDTH, 640)
#cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 480)

ret_val, img = cap.read()
fourcc = cv2.VideoWriter_fourcc('m', 'p', '4', 'v')
out_video = cv2.VideoWriter('/home/erich/Documents/results/connected.mp4', fourcc, cap.get(cv2.CAP_PROP_FPS), (1280, 720))
count = 0
